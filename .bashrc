...
alias gc1='git status | grep modified | lr 1 1 | c2 | xargs git checkout'
alias gc2='git status | grep modified | lr 2 2 | c2 | xargs git checkout'
alias gc3='git status | grep modified | lr 3 3 | c2 | xargs git checkout'
alias gc4='git status | grep modified | lr 4 4 | c2 | xargs git checkout'
alias gc5='git status | grep modified | lr 5 5 | c2 | xargs git checkout'
alias gc6='git status | grep modified | lr 6 6 | c2 | xargs git checkout'
alias gc7='git status | grep modified | lr 7 7 | c2 | xargs git checkout'
alias gc8='git status | grep modified | lr 8 8 | c2 | xargs git checkout'
alias gc9='git status | grep modified | lr 9 9 | c2 | xargs git checkout'
alias gs='git status'
...
#
PATH=$PATH:~/.local/bin
PATH=$PATH:~/installs/node-v12.15.0/bin
